...
- [ ] **Azure IoT Hub** (Standard tier, S1 or higher for scale)
...
- [ ] **Ethereum Sepolia RPC URL** (Infura, Alchemy, or own node)
...
DEVICE_REGISTRY_ADDRESS=0x<contract-address>
IOTHUB_CONNECTION=Endpoint=sb://<hub>.servicebus.windows.net/;SharedAccessKeyName=...
PQC_VERIFY_URL=https://<function-app>.azurewebsites.net/api/pqc/verify?code=...
APPINSIGHTS_INSTRUMENTATIONKEY=<instrumentation-key>
```

### 9.3 Raspberry Pi Setup
...
pip install azure-iot-device requests adafruit-circuitpython-dht oqs
...
# Copy project files
cp rpi_experiments2.py adaptive_config.py config.json latency_model_config.json ~/
cp pqc_kyber_helper.py pqc_sphincs_helper.py rpi_pqc_metrics.py ~/
